 ...
 */
final class Version20250224133050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trajet (id_trajet INT AUTO_INCREMENT NOT NULL, id_utilisateur INT NOT NULL, id_ville_depart INT NOT NULL, id_ville_arrivee INT NOT NULL, date_heure DATETIME NOT NULL, places_restantes INT NOT NULL, detail_trajet LONGTEXT DEFAULT NULL, INDEX IDX_2B5BA98C50EAE44 (id_utilisateur), INDEX IDX_2B5BA98C2E1C84D0 (id_ville_depart), INDEX IDX_2B5BA98CCE6859CD (id_ville_arrivee), PRIMARY KEY(id_trajet)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id_utilisateur INT AUTO_INCREMENT NOT NULL, id_role INT NOT NULL, id_ville INT NOT NULL, nom VARCHAR(200) NOT NULL, prenom VARCHAR(200) NOT NULL, email VARCHAR(200) NOT NULL, mot_de_passe VARCHAR(60) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX IDX_1D1C63B3DC499668 (id_role), INDEX IDX_1D1C63B3AD4698F3 (id_ville), PRIMARY KEY(id_utilisateur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voiture (id_voiture INT AUTO_INCREMENT NOT NULL, id_utilisateur INT NOT NULL, marque VARCHAR(100) NOT NULL, modele VARCHAR(100) NOT NULL, immatriculation VARCHAR(50) NOT NULL, nb_places INT NOT NULL, UNIQUE INDEX UNIQ_E9E2810FBE73422E (immatriculation), UNIQUE INDEX UNIQ_E9E2810F50EAE44 (id_utilisateur), PRIMARY KEY(id_voiture)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98C2E1C84D0 FOREIGN KEY (id_ville_depart) REFERENCES ville (id_ville)');
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98CCE6859CD FOREIGN KEY (id_ville_arrivee) REFERENCES ville (id_ville)');
