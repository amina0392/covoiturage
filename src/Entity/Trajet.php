...
class Trajet
{
    ...
    #[ORM\JoinColumn(name: "ville_depart", referencedColumnName: "id_ville", nullable: false)]
    private ?Ville $villeDepart = null;

    #[ORM\ManyToOne(targetEntity: Ville::class)]
    #[ORM\JoinColumn(name: "ville_arrivee", referencedColumnName: "id_ville", nullable: false)]
